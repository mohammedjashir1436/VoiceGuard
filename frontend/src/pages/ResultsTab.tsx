...
// XLS-R + AASIST is the deployed production detector.
const EER_RESULTS = [
  ...
  { model: 'wav2vec2-large-v2', eer: 12.67, prod: false },
]
...
function Stat({
  ...
  return (
    <div className="bg-gray-800 rounded-xl p-5 border border-gray-700">
      <p className={`text-3xl font-bold font-mono ${accent}`}>
        {value}
      </p>
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-sm text-gray-400">
          Detection evaluated on ASVspoof 2021 LA; robustness on
          held-out modern TTS systems.
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        ...
        <Stat
          value="93%"
          label="Kokoro detection"
          accent="text-green-400"
        />

        <Stat
          value="90%"
          label="Genuine-voice pass rate"
          accent="text-green-400"
        />
      </div>
      ...
      <div className="bg-gray-800 rounded-xl p-6">
        <p className="text-sm text-gray-400 mb-4">
          Equal Error Rate by model (lower is better)
        </p>
      ...
      <div className="bg-gray-800 rounded-xl p-6">
        <p className="text-sm text-gray-400 mb-4">
          Robustness to unseen voices — production model
          (XLS-R + AASIST)
        </p>
        ...
        <div className="space-y-3">
          {OOD.map(({ system, rate, kind }) => (
            ...
            >
              <span className="w-44 shrink-0 text-sm text-gray-300">
                {system}
              </span>
              ...
              <span className="w-10 text-right text-sm font-mono text-gray-300">
                {rate}%
              </span>
            </div>
          ))}
        ...
        <p className="mt-3 text-xs text-gray-600">
          Detection = % of deepfakes correctly flagged.
          Pass rate = % of genuine speech correctly accepted.
        </p>
      </div>
      ...
      <div className="bg-gray-800 rounded-xl p-6">
        ...
        {history.length === 0 ? (
          <p className="text-xs text-gray-600">
            Run detections in the Detect tab to populate this
            table.
          </p>
        ) : (
              ...
              <tbody className="divide-y divide-gray-800">
                {history.map((h) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-2 text-gray-300 max-w-[12rem] truncate">
                      {h.filename}
                    </td>
